...
HD_PWD='E:/sysclassfiles/cpu_1/cpu_1/cpu_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MIPS32_SYS.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MIPS32_SYS.tcl -notrace
