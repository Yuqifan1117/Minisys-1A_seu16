...
HD_PWD='E:/sysclassfiles/cpu_1/cpu_1/cpu_1.runs/program_rom0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log program_rom0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source program_rom0.tcl
