...
HD_PWD='E:/sysclassfiles/cpu_1/cpu_1/cpu_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MIPS32_SYS.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MIPS32_SYS.tcl
