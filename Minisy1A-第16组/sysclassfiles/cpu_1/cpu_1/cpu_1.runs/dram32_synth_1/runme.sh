...
HD_PWD='E:/sysclassfiles/cpu_1/cpu_1/cpu_1.runs/dram32_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dram32.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dram32.tcl
