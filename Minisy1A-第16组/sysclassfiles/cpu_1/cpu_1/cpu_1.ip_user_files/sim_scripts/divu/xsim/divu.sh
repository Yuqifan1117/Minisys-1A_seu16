...
#
# Generated by Vivado on Sat Jan 16 17:35:09 +0800 2021
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot divu xil_defaultlib.divu xil_defaultlib.glbl -log elaborate.log
}
