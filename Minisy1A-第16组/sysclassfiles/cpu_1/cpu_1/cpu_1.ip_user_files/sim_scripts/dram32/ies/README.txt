...
#
# Generated by export_simulation on Sat Jan 02 17:57:26 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './dram32.sh' script.
...
./dram32.sh -noclean_files

For more information on the script, please type './dram32.sh -help'.
