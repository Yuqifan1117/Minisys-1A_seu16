...
#
# Generated by export_simulation on Sun Jan 17 12:23:11 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './program_rom0.sh' script.

./program_rom0.sh -reset_run
...
./program_rom0.sh -noclean_files

For more information on the script, please type './program_rom0.sh -help'.
