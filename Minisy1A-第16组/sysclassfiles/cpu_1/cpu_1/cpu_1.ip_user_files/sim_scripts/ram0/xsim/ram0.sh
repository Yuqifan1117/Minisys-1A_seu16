...
#
# Generated by Vivado on Sun Jan 17 09:21:08 +0800 2021
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ram0 xil_defaultlib.ram0 xil_defaultlib.glbl -log elaborate.log
}
