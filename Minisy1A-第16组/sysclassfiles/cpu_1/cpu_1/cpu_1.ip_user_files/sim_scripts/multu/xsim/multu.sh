...
#
# Generated by Vivado on Sun Jan 10 16:18:01 +0800 2021
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot multu xil_defaultlib.multu xil_defaultlib.glbl -log elaborate.log
}
